controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    arrow = darts.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Projectile, shooter.x, shooter.y)
    arrow.setTrace(false)
    arrow.controlWithArrowKeys(true)
})
...
game.onUpdateInterval(400, function () {
    ...
    target = sprites.create(img`
        ...
        `, SpriteKind.Enemy)
    target.setFlag(SpriteFlag.AutoDestroy, true)
    if (random == 0) {
        target.setPosition(0, randint(0, 160))
    } else {
